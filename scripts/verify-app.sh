...
[[ "$(/usr/libexec/PlistBuddy -c 'Print :CFBundleIconName' "$app/Contents/Info.plist")" == Studio ]]
swift "$(dirname "${BASH_SOURCE[0]}")/verify-icon.swift" --catalog "$app/Contents/Resources/Assets.car"
